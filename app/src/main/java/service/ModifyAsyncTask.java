...
//                                    dbOperate.setChapterStatus(chapter.getWebBookId(), chapter.getWebId(), Constant.STATUS_OK);
//                                }
//                            },
...
//                            List<Chapter> tempChapters = dbOperate.getChapters(book.getUUID());
//                            if(dbOperate.getOKChapterNum(book.getUUID()) == tempChapters.size())
//                                chapters = null;
//                            else
//                                chapters = tempChapters;
//                            //将书和章节封装成一个json对象
//                            JSONObject json = BookUtil.getBookJson(book, chapters);
//                            json.remove("add_time");
//                            Log.d("web", "update, update a book basic info to web:"+json);
//                            //发送patch请求，修改书籍基本信息
//                            mRequestQueue.add(new MyJsonObjectRequest(
...
//                                                        dbOperate.setChapterID(
//                                                                book.getUUID(), chapter.getWebId(), ID);
//                                                        chapter.setWebBookId(book.getUUID());
//                                                        chapter.setWebId(ID);
//                                                    }
...
//                                            if (chapters!= null && book.getType() == Constant.TYPE_NOW)
//                                            {
//                                                //改变在读书籍的章节类型
//                                                for (final Chapter chapter : chapters) {
//                                                    if (chapter.getType() != Constant.TYPE_AFTER) {
//                                                        map.clear();
//                                                        String chapterUrl = Constant.URL_BOOKS + "/" + book.getUUID() + "/chapters/";
//                                                        //章节类型为在读和已读时进行修改，设置不同的url和参数
//                                                        switch (chapter.getType()) {
//                                                            case Constant.TYPE_NOW:
//                                                                chapterUrl += "readings/";
...
//                                                                        Log.d("web", "succeed reset a chapter type to web:" + response);
//                                                                        //修改章节类型成功，设置其状态为status_ok
//                                                                        dbOperate.setChapterStatus(book.getUUID(), chapter.getWebId(), Constant.STATUS_OK);
//                                                                    }
//                                                                },
//                                                                new Response.ErrorListener() {
//                                                                    @Override
