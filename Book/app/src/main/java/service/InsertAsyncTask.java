...
//                                                dbOperate.setBookUUID(book.getUUID(), UUID);
...
//                                                            UUID, chapter.getWebId(), ID);
//                                                    chapter.setWebBookId(UUID);
//                                                    chapter.setWebId(ID);
//                                                }
...
//                                                                            dbOperate.setChapterStatus(UUID, chapter.getWebId(), Constant.STATUS_OK);
//                                                                        }
//                                                                    },
//                                                                    new Response.ErrorListener() {
//                                                                        @Override
