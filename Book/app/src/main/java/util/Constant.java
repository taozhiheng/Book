...
public class Constant {
    ...
    public static int colors[]={Color.rgb(0xe9, 0x1e, 0x63),Color.rgb(0xf4,0x43,0x36),Color.rgb(0x7f,0xd6,0x8b),Color.rgb(0x21,0x96,0xf3),Color.rgb(0x86,0xa8,0xf8),Color.rgb(0xcb,0x8e,0xf6)};
